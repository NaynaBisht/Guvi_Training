...
set CLASSPATH=%APP_HOME%\lib\app.jar;%APP_HOME%\lib\guava-33.4.6-jre.jar;%APP_HOME%\lib\log4j-1.2.16.jar;%APP_HOME%\lib\log4j-core-2.22.1.jar;%APP_HOME%\lib\log4j-api-2.22.1.jar;%APP_HOME%\lib\failureaccess-1.0.3.jar;%APP_HOME%\lib\listenablefuture-9999.0-empty-to-avoid-conflict-with-guava.jar;%APP_HOME%\lib\jspecify-1.0.0.jar;%APP_HOME%\lib\error_prone_annotations-2.36.0.jar;%APP_HOME%\lib\j2objc-annotations-3.0.0.jar
